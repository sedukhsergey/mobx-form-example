...
import { ENV_DEV, ENV_PROD, ENV_TEST, ENV_UNDEFINED } from '../services/EnvironmentAwareService';

const HTTP_AUTH_IGNORED_ENVIRONMENTS = [ENV_PROD, ENV_TEST, ENV_UNDEFINED, ENV_DEV];
